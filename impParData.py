...
if __name__ == "__main__":
	...
	if user_input:
		...
		z_num = end // interval
	# 定义文件路径
	if midair_collisions:
		working_dir = "E:/Data/Sandripples1DFluid/uniform1"
		imp_data_file = os.path.join(working_dir, "impDataC.dat")
		imp_particle_file = os.path.join(working_dir, "impParticleC.dat")
	else:
		working_dir = "E:/Data/Sandripples1DFluid/noMidairColl1"
	...
	# 定义文件名字典
	my_dict = {
		0: "uStar030_200_0_2650_120",
		1: "uStar035_200_0_2650_120",
		2: "uStar035_200_0_3000_120",
		3: "uStar035_200_0_4000_120",
		4: "uStar035_200_2_2650_120",
		5: "uStar035_200_3_2650_120",
		6: "uStar035_250_0_2650_120",
		7: "uStar035_300_0_2650_120",
		8: "uStar035_350_0_2650_120",
		9: "uStar035_400_0_2650_120",
		10: "uStar040_200_0_2650_120",
		11: "uStar045_200_0_2650_120",
		12: "uStar045_200_0_3000_120",
		13: "uStar045_200_0_4000_120",
		14: "uStar045_200_2_2650_120",
		15: "uStar045_200_3_2650_120",
		16: "uStar045_250_0_2650_120",
		17: "uStar045_300_0_2650_120",
		18: "uStar045_350_0_2650_120",
		19: "uStar045_400_0_2650_120",
		20: "uStar050_200_0_2650_120",
		21: "uStar055_200_0_2650_120",
		22: "uStar055_200_0_3000_120",
		23: "uStar055_200_0_4000_120",
		24: "uStar055_200_2_2650_120",
		25: "uStar055_200_3_2650_120",
		26: "uStar055_250_0_2650_120",
		27: "uStar055_300_0_2650_120",
		28: "uStar055_350_0_2650_120",
		29: "uStar055_400_0_2650_120",
		30: "uStar060_200_0_2650_120",
	}
	uStar_list = []
	dia_list = []
	rho_list = []
	...
	for i, value in my_dict.items():
		...
		zone_num = last_time // interval
		zone_in_file = file_interval // interval
		file_num = zone_num // 8 + 1
		folder_name = value
		...
		survL_case_list = []
		collNum_case_list = []
		for current_time in range(start, end+1, interval):
			if z_num <= zone_num:
				current_data = time_step_data[current_time]
				impact_particle = [particle for particle in current_data.particles if particle.h <= zcell and particle.collNum >= 1 and particle.vel[2] < 0]
				...
				hMax_case_list.extend(hm_list)
				survT_case_list.extend(st_list)
				thT_case_list.extend(t_list)
				survL_case_list.extend(sl_list)
				collNum_case_list.extend(n_list)
		...
		current_imp_particle_file = os.path.join(working_dir, f"{folder_name}/impParticle.dat")
		if os.path.exists(current_imp_particle_file):
			os.remove(current_imp_particle_file)
		with open(current_imp_particle_file, 'w') as file:
			file.write("s Sh Ga hMax survT thSurvT survL collNum\n")
			for i in range(len(hm_list)):
				file.write(f"{s} {Sh} {Ga} {hMax_case_list[i]} {survT_case_list[i]} {thT_case_list[i]} {survL_case_list[i]} {collNum_case_list[i]}\n")
