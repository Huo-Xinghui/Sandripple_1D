...
from expData import get_exp_data
...
Q_nr1_in = np.load(f"Q_d300stdd50_{tail1}.npz")
M_nr1_in = np.load(f"M_d300stdd50_{tail1}.npz")
Q_md1_in = np.load(f"Q_d300stdd100_{tail1}.npz")
M_md1_in = np.load(f"M_d300stdd100_{tail1}.npz")
Q_wd1_in = np.load(f"Q_d300stdd200_{tail1}.npz")
M_wd1_in = np.load(f"M_d300stdd200_{tail1}.npz")
Q_vwd1_in = np.load(f"Q_d300stdd300_{tail1}.npz")
M_vwd1_in = np.load(f"M_d300stdd300_{tail1}.npz")
Q_nr1 = np.load(f"Q_d300stdd50_{tail2}.npz")
M_nr1 = np.load(f"M_d300stdd50_{tail2}.npz")
Q_md1 = np.load(f"Q_d300stdd100_{tail2}.npz")
M_md1 = np.load(f"M_d300stdd100_{tail2}.npz")
Q_wd1 = np.load(f"Q_d300stdd200_{tail2}.npz")
M_wd1 = np.load(f"M_d300stdd200_{tail2}.npz")
Q_vwd1 = np.load(f"Q_d300stdd300_{tail2}.npz")
M_vwd1 = np.load(f"M_d300stdd300_{tail2}.npz")
Q_nr2 = np.load(f"Q_d250stdd25_{tail1}.npz")
M_nr2 = np.load(f"M_d250stdd25_{tail1}.npz")
Q_md2 = np.load(f"Q_d271stdd121_{tail1}.npz")
M_md2 = np.load(f"M_d271stdd121_{tail1}.npz")
Q_wd2 = np.load(f"Q_d317stdd252_{tail1}.npz")
M_wd2 = np.load(f"M_d317stdd252_{tail1}.npz")
Q_vwd2 = np.load(f"Q_d347stdd537_{tail1}.npz")
M_vwd2 = np.load(f"M_d347stdd537_{tail1}.npz")
Q_nr3 = np.load(f"Q_d240stdd50_{tail1}.npz")
M_nr3 = np.load(f"M_d240stdd50_{tail1}.npz")
Q_nr4 = np.load(f"Q_d400stdd50_{tail1}.npz")
M_nr4 = np.load(f"M_d400stdd50_{tail1}.npz")
Q_nr2_out = np.load(f"Q_d250stdd25_{tail2}.npz")
M_nr2_out = np.load(f"M_d250stdd25_{tail2}.npz")
Q_md2_out = np.load(f"Q_d271stdd121_{tail2}.npz")
M_md2_out = np.load(f"M_d271stdd121_{tail2}.npz")
Q_wd2_out = np.load(f"Q_d317stdd252_{tail2}.npz")
M_wd2_out = np.load(f"M_d317stdd252_{tail2}.npz")
Q_vwd2_out = np.load(f"Q_d347stdd537_{tail2}.npz")
M_vwd2_out = np.load(f"M_d347stdd537_{tail2}.npz")
Q_nr3_in = np.load(f"Q_mono_d250stdd25_{tail1}.npz")
M_nr3_in = np.load(f"M_mono_d250stdd25_{tail1}.npz")
Q_md3_in = np.load(f"Q_mono_d271stdd121_{tail1}.npz")
M_md3_in = np.load(f"M_mono_d271stdd121_{tail1}.npz")
Q_wd3_in = np.load(f"Q_mono_d317stdd252_{tail1}.npz")
M_wd3_in = np.load(f"M_mono_d317stdd252_{tail1}.npz")
Q_vwd3_in = np.load(f"Q_mono_d347stdd537_{tail1}.npz")
M_vwd3_in = np.load(f"M_mono_d347stdd537_{tail1}.npz")
Q_nr4_in = np.load(f"Q_mono_d300stdd50_{tail1}.npz")
M_nr4_in = np.load(f"M_mono_d300stdd50_{tail1}.npz")
Q_md4_in = np.load(f"Q_mono_d300stdd100_{tail1}.npz")
M_md4_in = np.load(f"M_mono_d300stdd100_{tail1}.npz")
Q_wd4_in = np.load(f"Q_mono_d300stdd200_{tail1}.npz")
M_wd4_in = np.load(f"M_mono_d300stdd200_{tail1}.npz")
Q_vwd4_in = np.load(f"Q_mono_d300stdd300_{tail1}.npz")
M_vwd4_in = np.load(f"M_mono_d300stdd300_{tail1}.npz")
Q_nr5_in = np.load(f"Q_Eeff_d300stdd50_{tail1}.npz")
M_nr5_in = np.load(f"M_Eeff_d300stdd50_{tail1}.npz")
Q_md5_in = np.load(f"Q_Eeff_d300stdd100_{tail1}.npz")
M_md5_in = np.load(f"M_Eeff_d300stdd100_{tail1}.npz")
Q_wd5_in = np.load(f"Q_Eeff_d300stdd200_{tail1}.npz")
M_wd5_in = np.load(f"M_Eeff_d300stdd200_{tail1}.npz")
Q_vwd5_in = np.load(f"Q_Eeff_d300stdd300_{tail1}.npz")
M_vwd5_in = np.load(f"M_Eeff_d300stdd300_{tail1}.npz")
Q_nr5_out = np.load(f"Q_Eeff_d300stdd50_{tail2}.npz")
M_nr5_out = np.load(f"M_Eeff_d300stdd50_{tail2}.npz")
Q_md5_out = np.load(f"Q_Eeff_d300stdd100_{tail2}.npz")
M_md5_out = np.load(f"M_Eeff_d300stdd100_{tail2}.npz")
Q_wd5_out = np.load(f"Q_Eeff_d300stdd200_{tail2}.npz")
M_wd5_out = np.load(f"M_Eeff_d300stdd200_{tail2}.npz")
Q_vwd5_out = np.load(f"Q_Eeff_d300stdd300_{tail2}.npz")
M_vwd5_out = np.load(f"M_Eeff_d300stdd300_{tail2}.npz")
Q_nr6_in = np.load(f"Q_mono_d150stdd50_{tail1}.npz")
M_nr6_in = np.load(f"M_mono_d150stdd50_{tail1}.npz")
Q_md6_in = np.load(f"Q_mono_d150stdd100_{tail1}.npz")
M_md6_in = np.load(f"M_mono_d150stdd100_{tail1}.npz")
Q_wd6_in = np.load(f"Q_mono_d150stdd200_{tail1}.npz")
M_wd6_in = np.load(f"M_mono_d150stdd200_{tail1}.npz")
Q_vwd6_in = np.load(f"Q_mono_d150stdd300_{tail1}.npz")
M_vwd6_in = np.load(f"M_mono_d150stdd300_{tail1}.npz")
Q_mu1_out = np.load(f"Q_d167stdd100_{tail2}.npz")
M_mu1_out = np.load(f"M_d167stdd100_{tail2}.npz")
Q_mu2_out = np.load(f"Q_d197stdd65_{tail2}.npz")
M_mu2_out = np.load(f"M_d197stdd65_{tail2}.npz")
Q_mu3_out = np.load(f"Q_d290stdd97_{tail2}.npz")
M_mu3_out = np.load(f"M_d290stdd97_{tail2}.npz")
Q_mu4_out = np.load(f"Q_d430stdd100_{tail2}.npz")
M_mu4_out = np.load(f"M_d430stdd100_{tail2}.npz")
Q_rt_out = np.load(f"Q_d269stdd100_{tail2}.npz")
M_rt_out = np.load(f"M_d269stdd100_{tail2}.npz")
Q_lt_out = np.load(f"Q_d321stdd100_{tail2}.npz")
M_lt_out = np.load(f"M_d321stdd100_{tail2}.npz")
Q_nr7_out = np.load(f"Q_d240stdd50_{tail2}.npz")
M_nr7_out = np.load(f"M_d240stdd50_{tail2}.npz")
Q_nr8_out = np.load(f"Q_d400stdd50_{tail2}.npz")
M_nr8_out = np.load(f"M_d400stdd50_{tail2}.npz")
Q_nr9_in = np.load(f"Q_monobed_d300stdd50_{tail1}.npz")
M_nr9_in = np.load(f"M_monobed_d300stdd50_{tail1}.npz")
Q_md9_in = np.load(f"Q_monobed_d300stdd100_{tail1}.npz")
M_md9_in = np.load(f"M_monobed_d300stdd100_{tail1}.npz")
Q_wd9_in = np.load(f"Q_monobed_d300stdd200_{tail1}.npz")
M_wd9_in = np.load(f"M_monobed_d300stdd200_{tail1}.npz")
Q_vwd9_in = np.load(f"Q_monobed_d300stdd300_{tail1}.npz")
M_vwd9_in = np.load(f"M_monobed_d300stdd300_{tail1}.npz")
Q_nr9_out = np.load(f"Q_monobed_d300stdd50_{tail2}.npz")
M_nr9_out = np.load(f"M_monobed_d300stdd50_{tail2}.npz")
Q_md9_out = np.load(f"Q_monobed_d300stdd100_{tail2}.npz")
M_md9_out = np.load(f"M_monobed_d300stdd100_{tail2}.npz")
Q_wd9_out = np.load(f"Q_monobed_d300stdd200_{tail2}.npz")
M_wd9_out = np.load(f"M_monobed_d300stdd200_{tail2}.npz")
Q_vwd9_out = np.load(f"Q_monobed_d300stdd300_{tail2}.npz")
M_vwd9_out = np.load(f"M_monobed_d300stdd300_{tail2}.npz")
Q_mu1_in = np.load(f"Q_d167stdd100_{tail1}.npz")
M_mu1_in = np.load(f"M_d167stdd100_{tail1}.npz")
Q_mu2_in = np.load(f"Q_d197stdd65_{tail1}.npz")
M_mu2_in = np.load(f"M_d197stdd65_{tail1}.npz")
Q_mu3_in = np.load(f"Q_d290stdd97_{tail1}.npz")
M_mu3_in = np.load(f"M_d290stdd97_{tail1}.npz")
Q_mu4_in = np.load(f"Q_d430stdd100_{tail1}.npz")
M_mu4_in = np.load(f"M_d430stdd100_{tail1}.npz")
Q_rt_in = np.load(f"Q_d269stdd100_{tail1}.npz")
M_rt_in = np.load(f"M_d269stdd100_{tail1}.npz")
Q_lt_in = np.load(f"Q_d321stdd100_{tail1}.npz")
M_lt_in = np.load(f"M_d321stdd100_{tail1}.npz")
Q_nr7_in = np.load(f"Q_d240stdd50_{tail1}.npz")
M_nr7_in = np.load(f"M_d240stdd50_{tail1}.npz")
Q_nr8_in = np.load(f"Q_d400stdd50_{tail1}.npz")
M_nr8_in = np.load(f"M_d400stdd50_{tail1}.npz")
Q_nr10_in = np.load(f"Q_monobed_d250stdd25_{tail1}.npz")
M_nr10_in = np.load(f"M_monobed_d250stdd25_{tail1}.npz")
Q_md10_in = np.load(f"Q_monobed_d271stdd121_{tail1}.npz")
M_md10_in = np.load(f"M_monobed_d271stdd121_{tail1}.npz")
Q_wd10_in = np.load(f"Q_monobed_d317stdd252_{tail1}.npz")
M_wd10_in = np.load(f"M_monobed_d317stdd252_{tail1}.npz")
Q_vwd10_in = np.load(f"Q_monobed_d347stdd537_{tail1}.npz")
M_vwd10_in = np.load(f"M_monobed_d347stdd537_{tail1}.npz")
Q_nr10_out = np.load(f"Q_monobed_d250stdd25_{tail2}.npz")
M_nr10_out = np.load(f"M_monobed_d250stdd25_{tail2}.npz")
Q_md10_out = np.load(f"Q_monobed_d271stdd121_{tail2}.npz")
M_md10_out = np.load(f"M_monobed_d271stdd121_{tail2}.npz")
Q_wd10_out = np.load(f"Q_monobed_d317stdd252_{tail2}.npz")
M_wd10_out = np.load(f"M_monobed_d317stdd252_{tail2}.npz")
Q_vwd10_out = np.load(f"Q_monobed_d347stdd537_{tail2}.npz")
M_vwd10_out = np.load(f"M_monobed_d347stdd537_{tail2}.npz")
...
Q_rslt = {
	# 0
	f"d300stdd50_{tail2}": Q_nr1,
	f"d300stdd100_{tail2}": Q_md1,
	f"d300stdd200_{tail2}": Q_wd1,
	f"d300stdd300_{tail2}": Q_vwd1,
	f"d300stdd50_{tail1}": Q_nr1_in,
	f"d300stdd100_{tail1}": Q_md1_in,
	f"d300stdd200_{tail1}": Q_wd1_in,
	f"d300stdd300_{tail1}": Q_vwd1_in,

	f"d300stdd50_mb_{tail1}": Q_nr9_in,
	f"d300stdd100_mb_{tail1}": Q_md9_in,
	f"d300stdd200_mb_{tail1}": Q_wd9_in,
	f"d300stdd300_mb_{tail1}": Q_vwd9_in,
	f"d300stdd50_mb_{tail2}": Q_nr9_out,
	f"d300stdd100_mb_{tail2}": Q_md9_out,
	f"d300stdd200_mb_{tail2}": Q_wd9_out,
	f"d300stdd300_mb_{tail2}": Q_vwd9_out,

	f"d300stdd50_m_{tail1}": Q_nr4_in,
	f"d300stdd100_m_{tail1}": Q_md4_in,
	f"d300stdd200_m_{tail1}": Q_wd4_in,
	f"d300stdd300_m_{tail1}": Q_vwd4_in,

	f"d300stdd50_e_{tail1}": Q_nr5_in,
	f"d300stdd100_e_{tail1}": Q_md5_in,
	f"d300stdd200_e_{tail1}": Q_wd5_in,
	f"d300stdd300_e_{tail1}": Q_vwd5_in,
	f"d300stdd50_e_{tail2}": Q_nr5_out,
	f"d300stdd100_e_{tail2}": Q_md5_out,
	f"d300stdd200_e_{tail2}": Q_wd5_out,
	f"d300stdd300_e_{tail2}": Q_vwd5_out,
	# 1
	f"d250stdd25_{tail1}": Q_nr2,
	f"d271stdd121_{tail1}": Q_md2,
	f"d317stdd252_{tail1}": Q_wd2,
	f"d347stdd537_{tail1}": Q_vwd2,
	f"d250stdd25_{tail2}": Q_nr2_out,
	f"d271stdd121_{tail2}": Q_md2_out,
	f"d317stdd252_{tail2}": Q_wd2_out,
	f"d347stdd537_{tail2}": Q_vwd2_out,

	f"d250stdd25_m_{tail1}": Q_nr3_in,
	f"d271stdd121_m_{tail1}": Q_md3_in,
	f"d317stdd252_m_{tail1}": Q_wd3_in,
	f"d347stdd537_m_{tail1}": Q_vwd3_in,

	f"d250stdd25_mb_{tail1}": Q_nr10_in,
	f"d271stdd121_mb_{tail1}": Q_md10_in,
	f"d317stdd252_mb_{tail1}": Q_wd10_in,
	f"d347stdd537_mb_{tail1}": Q_vwd10_in,
	f"d250stdd25_mb_{tail2}": Q_nr10_out,
	f"d271stdd121_mb_{tail2}": Q_md10_out,
	f"d317stdd252_mb_{tail2}": Q_wd10_out,
	f"d347stdd537_mb_{tail2}": Q_vwd10_out,
	# 2
	f"d167stdd100_{tail2}": Q_mu1_out,
	f"d197stdd65_{tail2}": Q_mu2_out,
	f"d290stdd97_{tail2}": Q_mu3_out,
	f"d430stdd100_{tail2}": Q_mu4_out,
	f"d167stdd100_{tail1}": Q_mu1_in,
	f"d197stdd65_{tail1}": Q_mu2_in,
	f"d290stdd97_{tail1}": Q_mu3_in,
	f"d430stdd100_{tail1}": Q_mu4_in,
	# 3
	f"d269stdd100_{tail2}": Q_rt_out,
	f"d321stdd100_{tail2}": Q_lt_out,
	f"d269stdd100_{tail1}": Q_rt_in,
	f"d321stdd100_{tail1}": Q_lt_in,
	# 4
	f"d240stdd50_{tail2}": Q_nr7_out,
	f"d400stdd50_{tail2}": Q_nr8_out,
	f"d240stdd50_{tail1}": Q_nr7_in,
	f"d400stdd50_{tail1}": Q_nr8_in,

	f"d150stdd50_m_{tail1}": Q_nr6_in,
	f"d150stdd100_m_{tail1}": Q_md6_in,
	f"d150stdd200_m_{tail1}": Q_wd6_in,
	f"d150stdd300_m_{tail1}": Q_vwd6_in,
}

M_rslt = {
	# 0
	f"d300stdd50_{tail2}": M_nr1,
	f"d300stdd100_{tail2}": M_md1,
	f"d300stdd200_{tail2}": M_wd1,
	f"d300stdd300_{tail2}": M_vwd1,
	f"d300stdd50_{tail1}": M_nr1_in,
	f"d300stdd100_{tail1}": M_md1_in,
	f"d300stdd200_{tail1}": M_wd1_in,
	f"d300stdd300_{tail1}": M_vwd1_in,

	f"d300stdd50_mb_{tail1}": M_nr9_in,
	f"d300stdd100_mb_{tail1}": M_md9_in,
	f"d300stdd200_mb_{tail1}": M_wd9_in,
	f"d300stdd300_mb_{tail1}": M_vwd9_in,
	f"d300stdd50_mb_{tail2}": M_nr9_out,
	f"d300stdd100_mb_{tail2}": M_md9_out,
	f"d300stdd200_mb_{tail2}": M_wd9_out,
	f"d300stdd300_mb_{tail2}": M_vwd9_out,

	f"d300stdd50_m_{tail1}": M_nr4_in,
	f"d300stdd100_m_{tail1}": M_md4_in,
	f"d300stdd200_m_{tail1}": M_wd4_in,
	f"d300stdd300_m_{tail1}": M_vwd4_in,

	f"d300stdd50_e_{tail1}": M_nr5_in,
	f"d300stdd100_e_{tail1}": M_md5_in,
	f"d300stdd200_e_{tail1}": M_wd5_in,
	f"d300stdd300_e_{tail1}": M_vwd5_in,
	f"d300stdd50_e_{tail2}": M_nr5_out,
	f"d300stdd100_e_{tail2}": M_md5_out,
	f"d300stdd200_e_{tail2}": M_wd5_out,
	f"d300stdd300_e_{tail2}": M_vwd5_out,
	# 1
	f"d250stdd25_{tail1}": M_nr2,
	f"d271stdd121_{tail1}": M_md2,
	f"d317stdd252_{tail1}": M_wd2,
	f"d347stdd537_{tail1}": M_vwd2,
	f"d250stdd25_{tail2}": M_nr2_out,
	f"d271stdd121_{tail2}": M_md2_out,
	f"d317stdd252_{tail2}": M_wd2_out,
	f"d347stdd537_{tail2}": M_vwd2_out,

	f"d250stdd25_m_{tail1}": M_nr3_in,
	f"d271stdd121_m_{tail1}": M_md3_in,
	f"d317stdd252_m_{tail1}": M_wd3_in,
	f"d347stdd537_m_{tail1}": M_vwd3_in,

	f"d250stdd25_mb_{tail1}": M_nr10_in,
	f"d271stdd121_mb_{tail1}": M_md10_in,
	f"d317stdd252_mb_{tail1}": M_wd10_in,
	f"d347stdd537_mb_{tail1}": M_vwd10_in,
	f"d250stdd25_mb_{tail2}": M_nr10_out,
	f"d271stdd121_mb_{tail2}": M_md10_out,
	f"d317stdd252_mb_{tail2}": M_wd10_out,
	f"d347stdd537_mb_{tail2}": M_vwd10_out,
	# 2
	f"d167stdd100_{tail2}": M_mu1_out,
	f"d197stdd65_{tail2}": M_mu2_out,
	f"d290stdd97_{tail2}": M_mu3_out,
	f"d430stdd100_{tail2}": M_mu4_out,
	f"d167stdd100_{tail1}": M_mu1_in,
	f"d197stdd65_{tail1}": M_mu2_in,
	f"d290stdd97_{tail1}": M_mu3_in,
	f"d430stdd100_{tail1}": M_mu4_in,
	# 3
	f"d269stdd100_{tail2}": M_rt_out,
	f"d321stdd100_{tail2}": M_lt_out,
	f"d269stdd100_{tail1}": M_rt_in,
	f"d321stdd100_{tail1}": M_lt_in,
	# 4
	f"d240stdd50_{tail2}": M_nr7_out,
	f"d400stdd50_{tail2}": M_nr8_out,
	f"d240stdd50_{tail1}": M_nr3,
	f"d400stdd50_{tail1}": M_nr4,

	f"d150stdd50_m_{tail1}": M_nr6_in,
	f"d150stdd100_m_{tail1}": M_md6_in,
	f"d150stdd200_m_{tail1}": M_wd6_in,
	f"d150stdd300_m_{tail1}": M_vwd6_in,
}
...
ks0 = Q_rslt[f"d300stdd50_{tail2}"]["fit"][0]
ks1 = Q_rslt[f"d300stdd100_{tail2}"]["fit"][0]
ks2 = Q_rslt[f"d300stdd200_{tail2}"]["fit"][0]
ks3 = Q_rslt[f"d300stdd300_{tail2}"]["fit"][0]
ks10 = Q_rslt[f"d250stdd25_{tail2}"]["fit"][0]
ks11 = Q_rslt[f"d271stdd121_{tail2}"]["fit"][0]
ks12 = Q_rslt[f"d317stdd252_{tail2}"]["fit"][0]
ks13 = Q_rslt[f"d347stdd537_{tail2}"]["fit"][0]
ks20 = Q_rslt[f"d167stdd100_{tail2}"]["fit"][0]
ks21 = Q_rslt[f"d197stdd65_{tail2}"]["fit"][0]
ks22 = Q_rslt[f"d290stdd97_{tail2}"]["fit"][0]
ks23 = Q_rslt[f"d430stdd100_{tail2}"]["fit"][0]
ks30 = Q_rslt[f"d269stdd100_{tail2}"]["fit"][0]
ks31 = Q_rslt[f"d321stdd100_{tail2}"]["fit"][0]
ks40 = Q_rslt[f"d240stdd50_{tail2}"]["fit"][0]
ks41 = Q_rslt[f"d400stdd50_{tail2}"]["fit"][0]
...
vx0 = Q_rslt[f"d300stdd50_mb_{tail2}"]['y'] / M_rslt[f"d300stdd50_mb_{tail2}"]['y']
vx1 = Q_rslt[f"d300stdd100_mb_{tail2}"]['y'] / M_rslt[f"d300stdd100_mb_{tail2}"]['y']
vx2 = Q_rslt[f"d300stdd200_mb_{tail2}"]['y'] / M_rslt[f"d300stdd200_mb_{tail2}"]['y']
vx3 = Q_rslt[f"d300stdd300_mb_{tail2}"]['y'] / M_rslt[f"d300stdd300_mb_{tail2}"]['y']
vx00 = Q_rslt[f"d300stdd50_{tail2}"]['y'] / M_rslt[f"d300stdd50_{tail2}"]['y']
vx01 = Q_rslt[f"d300stdd100_{tail2}"]['y'] / M_rslt[f"d300stdd100_{tail2}"]['y']
vx02 = Q_rslt[f"d300stdd200_{tail2}"]['y'] / M_rslt[f"d300stdd200_{tail2}"]['y']
vx03 = Q_rslt[f"d300stdd300_{tail2}"]['y'] / M_rslt[f"d300stdd300_{tail2}"]['y']
vx10 = Q_rslt[f"d250stdd25_{tail2}"]['y'] / M_rslt[f"d250stdd25_{tail2}"]['y']
vx11 = Q_rslt[f"d271stdd121_{tail2}"]['y'] / M_rslt[f"d271stdd121_{tail2}"]['y']
vx12 = Q_rslt[f"d317stdd252_{tail2}"]['y'] / M_rslt[f"d317stdd252_{tail2}"]['y']
vx13 = Q_rslt[f"d347stdd537_{tail2}"]['y'] / M_rslt[f"d347stdd537_{tail2}"]['y']
vx20 = Q_rslt[f"d167stdd100_{tail2}"]['y'] / M_rslt[f"d167stdd100_{tail2}"]['y']
vx21 = Q_rslt[f"d197stdd65_{tail2}"]['y'] / M_rslt[f"d197stdd65_{tail2}"]['y']
vx22 = Q_rslt[f"d290stdd97_{tail2}"]['y'] / M_rslt[f"d290stdd97_{tail2}"]['y']
vx23 = Q_rslt[f"d430stdd100_{tail2}"]['y'] / M_rslt[f"d430stdd100_{tail2}"]['y']
vx30 = Q_rslt[f"d269stdd100_{tail2}"]['y'] / M_rslt[f"d269stdd100_{tail2}"]['y']
vx31 = Q_rslt[f"d321stdd100_{tail2}"]['y'] / M_rslt[f"d321stdd100_{tail2}"]['y']
vx40 = Q_rslt[f"d240stdd50_{tail2}"]['y'] / M_rslt[f"d240stdd50_{tail2}"]['y']
vx41 = Q_rslt[f"d400stdd50_{tail2}"]['y'] / M_rslt[f"d400stdd50_{tail2}"]['y']

vx00_50 = Q_rslt[f"d300stdd50_{tail1}"]['y'] / M_rslt[f"d300stdd50_{tail1}"]['y']
vx01_50 = Q_rslt[f"d300stdd100_{tail1}"]['y'] / M_rslt[f"d300stdd100_{tail1}"]['y']
vx02_50 = Q_rslt[f"d300stdd200_{tail1}"]['y'] / M_rslt[f"d300stdd200_{tail1}"]['y']
vx03_50 = Q_rslt[f"d300stdd300_{tail1}"]['y'] / M_rslt[f"d300stdd300_{tail1}"]['y']
vx10_50 = Q_rslt[f"d250stdd25_{tail1}"]['y'] / M_rslt[f"d250stdd25_{tail1}"]['y']
vx11_50 = Q_rslt[f"d271stdd121_{tail1}"]['y'] / M_rslt[f"d271stdd121_{tail1}"]['y']
vx12_50 = Q_rslt[f"d317stdd252_{tail1}"]['y'] / M_rslt[f"d317stdd252_{tail1}"]['y']
vx13_50 = Q_rslt[f"d347stdd537_{tail1}"]['y'] / M_rslt[f"d347stdd537_{tail1}"]['y']
vx20_50 = Q_rslt[f"d167stdd100_{tail1}"]['y'] / M_rslt[f"d167stdd100_{tail1}"]['y']
vx21_50 = Q_rslt[f"d197stdd65_{tail1}"]['y'] / M_rslt[f"d197stdd65_{tail1}"]['y']
vx22_50 = Q_rslt[f"d290stdd97_{tail1}"]['y'] / M_rslt[f"d290stdd97_{tail1}"]['y']
vx23_50 = Q_rslt[f"d430stdd100_{tail1}"]['y'] / M_rslt[f"d430stdd100_{tail1}"]['y']
vx30_50 = Q_rslt[f"d269stdd100_{tail1}"]['y'] / M_rslt[f"d269stdd100_{tail1}"]['y']
vx31_50 = Q_rslt[f"d321stdd100_{tail1}"]['y'] / M_rslt[f"d321stdd100_{tail1}"]['y']
vx40_50 = Q_rslt[f"d240stdd50_{tail1}"]['y'] / M_rslt[f"d240stdd50_{tail1}"]['y']
vx41_50 = Q_rslt[f"d400stdd50_{tail1}"]['y'] / M_rslt[f"d400stdd50_{tail1}"]['y']
...
#
#ks0 = M_rslt[f"d300stdd50_{tail1}"]["fit"][0]
#ks1 = M_rslt[f"d300stdd100_{tail1}"]["fit"][0]
#ks2 = M_rslt[f"d300stdd200_{tail1}"]["fit"][0]
#ks3 = M_rslt[f"d300stdd300_{tail1}"]["fit"][0]
#k0 = -M_rslt[f"d300stdd50_{tail1}"]["fit"][1]/ks0
#k1 = -M_rslt[f"d300stdd100_{tail1}"]["fit"][1]/ks1
#k2 = -M_rslt[f"d300stdd200_{tail1}"]["fit"][1]/ks2
#k3 = -M_rslt[f"d300stdd300_{tail1}"]["fit"][1]/ks3
#ks00 = M_rslt[f"d300stdd50_mb_{tail1}"]["fit"][0]
#ks01 = M_rslt[f"d300stdd100_mb_{tail1}"]["fit"][0]
#ks02 = M_rslt[f"d300stdd200_mb_{tail1}"]["fit"][0]
#ks03 = M_rslt[f"d300stdd300_mb_{tail1}"]["fit"][0]
#k00 = -M_rslt[f"d300stdd50_mb_{tail1}"]["fit"][1]/ks0
#k01 = -M_rslt[f"d300stdd100_mb_{tail1}"]["fit"][1]/ks1
#k02 = -M_rslt[f"d300stdd200_mb_{tail1}"]["fit"][1]/ks2
#k03 = -M_rslt[f"d300stdd300_mb_{tail1}"]["fit"][1]/ks3
##ks10 = M_rslt[f"d250stdd25_m_{tail1}"]["fit"][0]
##ks11 = M_rslt[f"d271stdd121_m_{tail1}"]["fit"][0]
##ks12 = M_rslt[f"d317stdd252_m_{tail1}"]["fit"][0]
##ks13 = M_rslt[f"d347stdd537_m_{tail1}"]["fit"][0]
##k10 = -M_rslt[f"d250stdd25_m_{tail1}"]["fit"][1]/ks10
##k11 = -M_rslt[f"d271stdd121_m_{tail1}"]["fit"][1]/ks11
##k12 = -M_rslt[f"d317stdd252_m_{tail1}"]["fit"][1]/ks12
##k13 = -M_rslt[f"d347stdd537_m_{tail1}"]["fit"][1]/ks13
##ks21 = M_rslt[f"d150stdd50_m_{tail1}"]["fit"][0]
##ks22 = M_rslt[f"d150stdd100_m_{tail1}"]["fit"][0]
##ks23 = M_rslt[f"d150stdd200_m_{tail1}"]["fit"][0]
##ks24 = M_rslt[f"d150stdd300_m_{tail1}"]["fit"][0]
##k21 = -M_rslt[f"d150stdd50_m_{tail1}"]["fit"][1]/ks21
##k22 = -M_rslt[f"d150stdd100_m_{tail1}"]["fit"][1]/ks22
##k23 = -M_rslt[f"d150stdd200_m_{tail1}"]["fit"][1]/ks23
##k24 = -M_rslt[f"d150stdd300_m_{tail1}"]["fit"][1]/ks24
#
...
#
#k0 = M_rslt[f"d300stdd50_{tail1}"]["fit"][0]
#k1 = M_rslt[f"d300stdd100_{tail1}"]["fit"][0]
#k2 = M_rslt[f"d300stdd200_{tail1}"]["fit"][0]
#k3 = M_rslt[f"d300stdd300_{tail1}"]["fit"][0]
#k10 = M_rslt[f"d250stdd25_{tail1}"]["fit"][0]
#k11 = M_rslt[f"d271stdd121_{tail1}"]["fit"][0]
#k12 = M_rslt[f"d317stdd252_{tail1}"]["fit"][0]
#k13 = M_rslt[f"d347stdd537_{tail1}"]["fit"][0]
#k20 = M_rslt[f"d300stdd50_m_{tail1}"]["fit"][0]
#k21 = M_rslt[f"d300stdd100_m_{tail1}"]["fit"][0]
#k22 = M_rslt[f"d300stdd200_m_{tail1}"]["fit"][0]
#k23 = M_rslt[f"d300stdd300_m_{tail1}"]["fit"][0]
#k30 = M_rslt[f"d250stdd25_m_{tail1}"]["fit"][0]
#k31 = M_rslt[f"d271stdd121_m_{tail1}"]["fit"][0]
#k32 = M_rslt[f"d317stdd252_m_{tail1}"]["fit"][0]
#k33 = M_rslt[f"d347stdd537_m_{tail1}"]["fit"][0]
#k_list = [k0, k1, k2, k3]
#k1_list = [k10, k11, k12, k13]
...
x = np.concatenate([
					M_rslt[f"d300stdd50_{tail2}"]["y"],
                    M_rslt[f"d300stdd100_{tail2}"]["y"],
                    M_rslt[f"d300stdd200_{tail2}"]["y"],
                    M_rslt[f"d300stdd300_{tail2}"]["y"],
                    M_rslt[f"d250stdd25_{tail2}"]["y"],
                    M_rslt[f"d271stdd121_{tail2}"]["y"],
                    M_rslt[f"d317stdd252_{tail2}"]["y"],
                    M_rslt[f"d347stdd537_{tail2}"]["y"],
					M_rslt[f"d167stdd100_{tail2}"]["y"],
					M_rslt[f"d197stdd65_{tail2}"]["y"],
					M_rslt[f"d290stdd97_{tail2}"]["y"],
					M_rslt[f"d430stdd100_{tail2}"]["y"],
					M_rslt[f"d269stdd100_{tail2}"]["y"],
					M_rslt[f"d321stdd100_{tail2}"]["y"],
					M_rslt[f"d240stdd50_{tail2}"]["y"],
					M_rslt[f"d400stdd50_{tail2}"]["y"],
					])
...
ks0 = -M_rslt[f"d300stdd50_{tail2}"]["fit"][1]/M_rslt[f"d300stdd50_{tail2}"]["fit"][0]
ks1 = -M_rslt[f"d300stdd100_{tail2}"]["fit"][1]/M_rslt[f"d300stdd100_{tail2}"]["fit"][0]
ks2 = -M_rslt[f"d300stdd200_{tail2}"]["fit"][1]/M_rslt[f"d300stdd200_{tail2}"]["fit"][0]
ks3 = -M_rslt[f"d300stdd300_{tail2}"]["fit"][1]/M_rslt[f"d300stdd300_{tail2}"]["fit"][0]
ks10 = -M_rslt[f"d250stdd25_{tail2}"]["fit"][1]/M_rslt[f"d250stdd25_{tail2}"]["fit"][0]
ks11 = -M_rslt[f"d271stdd121_{tail2}"]["fit"][1]/M_rslt[f"d271stdd121_{tail2}"]["fit"][0]
ks12 = -M_rslt[f"d317stdd252_{tail2}"]["fit"][1]/M_rslt[f"d317stdd252_{tail2}"]["fit"][0]
ks13 = -M_rslt[f"d347stdd537_{tail2}"]["fit"][1]/M_rslt[f"d347stdd537_{tail2}"]["fit"][0]
ks20 = -M_rslt[f"d167stdd100_{tail2}"]["fit"][1]/M_rslt[f"d167stdd100_{tail2}"]["fit"][0]
ks21 = -M_rslt[f"d197stdd65_{tail2}"]["fit"][1]/M_rslt[f"d197stdd65_{tail2}"]["fit"][0]
ks22 = -M_rslt[f"d290stdd97_{tail2}"]["fit"][1]/M_rslt[f"d290stdd97_{tail2}"]["fit"][0]
ks23 = -M_rslt[f"d430stdd100_{tail2}"]["fit"][1]/M_rslt[f"d430stdd100_{tail2}"]["fit"][0]
ks30 = -M_rslt[f"d269stdd100_{tail2}"]["fit"][1]/M_rslt[f"d269stdd100_{tail2}"]["fit"][0]
ks31 = -M_rslt[f"d321stdd100_{tail2}"]["fit"][1]/M_rslt[f"d321stdd100_{tail2}"]["fit"][0]
ks40 = -M_rslt[f"d240stdd50_{tail2}"]["fit"][1]/M_rslt[f"d240stdd50_{tail2}"]["fit"][0]
ks41 = -M_rslt[f"d400stdd50_{tail2}"]["fit"][1]/M_rslt[f"d400stdd50_{tail2}"]["fit"][0]

ksm0 = -M_rslt[f"d300stdd50_{tail1}"]["fit"][1]/M_rslt[f"d300stdd50_{tail1}"]["fit"][0]
ksm1 = -M_rslt[f"d300stdd100_{tail1}"]["fit"][1]/M_rslt[f"d300stdd100_{tail1}"]["fit"][0]
ksm2 = -M_rslt[f"d300stdd200_{tail1}"]["fit"][1]/M_rslt[f"d300stdd200_{tail1}"]["fit"][0]
ksm3 = -M_rslt[f"d300stdd300_{tail1}"]["fit"][1]/M_rslt[f"d300stdd300_{tail1}"]["fit"][0]
ksm10 = -M_rslt[f"d250stdd25_{tail1}"]["fit"][1]/M_rslt[f"d250stdd25_{tail1}"]["fit"][0]
ksm11 = -M_rslt[f"d271stdd121_{tail1}"]["fit"][1]/M_rslt[f"d271stdd121_{tail1}"]["fit"][0]
ksm12 = -M_rslt[f"d317stdd252_{tail1}"]["fit"][1]/M_rslt[f"d317stdd252_{tail1}"]["fit"][0]
ksm13 = -M_rslt[f"d347stdd537_{tail1}"]["fit"][1]/M_rslt[f"d347stdd537_{tail1}"]["fit"][0]
ksm20 = -M_rslt[f"d167stdd100_{tail1}"]["fit"][1]/M_rslt[f"d167stdd100_{tail1}"]["fit"][0]
ksm21 = -M_rslt[f"d197stdd65_{tail1}"]["fit"][1]/M_rslt[f"d197stdd65_{tail1}"]["fit"][0]
ksm22 = -M_rslt[f"d290stdd97_{tail1}"]["fit"][1]/M_rslt[f"d290stdd97_{tail1}"]["fit"][0]
ksm23 = -M_rslt[f"d430stdd100_{tail1}"]["fit"][1]/M_rslt[f"d430stdd100_{tail1}"]["fit"][0]
ksm30 = -M_rslt[f"d269stdd100_{tail1}"]["fit"][1]/M_rslt[f"d269stdd100_{tail1}"]["fit"][0]
ksm31 = -M_rslt[f"d321stdd100_{tail1}"]["fit"][1]/M_rslt[f"d321stdd100_{tail1}"]["fit"][0]
ksm40 = -M_rslt[f"d240stdd50_{tail1}"]["fit"][1]/M_rslt[f"d240stdd50_{tail1}"]["fit"][0]
ksm41 = -M_rslt[f"d400stdd50_{tail1}"]["fit"][1]/M_rslt[f"d400stdd50_{tail1}"]["fit"][0]

ksmb0 = -M_rslt[f"d300stdd50_mb_{tail1}"]["fit"][1]/M_rslt[f"d300stdd50_{tail1}"]["fit"][0]
ksmb1 = -M_rslt[f"d300stdd100_mb_{tail1}"]["fit"][1]/M_rslt[f"d300stdd100_{tail1}"]["fit"][0]
ksmb2 = -M_rslt[f"d300stdd200_mb_{tail1}"]["fit"][1]/M_rslt[f"d300stdd200_mb_{tail1}"]["fit"][0]
ksmb3 = -M_rslt[f"d300stdd300_mb_{tail1}"]["fit"][1]/M_rslt[f"d300stdd300_mb_{tail1}"]["fit"][0]
ksmb10 = -M_rslt[f"d250stdd25_mb_{tail1}"]["fit"][1]/M_rslt[f"d250stdd25_mb_{tail1}"]["fit"][0]
ksmb11 = -M_rslt[f"d271stdd121_mb_{tail1}"]["fit"][1]/M_rslt[f"d271stdd121_mb_{tail1}"]["fit"][0]
ksmb12 = -M_rslt[f"d317stdd252_mb_{tail1}"]["fit"][1]/M_rslt[f"d317stdd252_mb_{tail1}"]["fit"][0]
ksmb13 = -M_rslt[f"d347stdd537_mb_{tail1}"]["fit"][1]/M_rslt[f"d347stdd537_mb_{tail1}"]["fit"][0]
