...
inset_ax.plot(x2, y2, 'd', color='grey', markersize=marker_size, label='Other Cases')
...
ax.legend([(proxy_ro, proxy_ro_h),
		   ...
		   (proxy_yD, proxy_yD_h),
		   others],
          ['NR1, NR2', 'MD1, MD2', 'WD1, WD2', 'VWD1, VWD2', 'RT, LT', 'Other Cases'],
		  handler_map={tuple: HandlerTuple(ndivide=None)},
          fontsize=ticks_size,
          loc='upper left',
...
inset_ax.xaxis.tick_top()
inset_ax.xaxis.set_label_position("top")
inset_ax.set_xlabel('$\\ln(\\eta_d^\\mathrm{bed})^2$', fontsize=label_size, labelpad=10)
inset_ax.set_ylabel('$\\ln(d_{90}^{\\mathrm{air}}/d_{90}^{\\mathrm{bed}})$', fontsize=label_size)
inset_ax.tick_params(axis='both', labelsize=ticks_size)
#inset_ax.legend(fontsize=ticks_size,
#				loc='lower left',
...
ax.plot(x90, y90, 'C0o', linewidth=line_width, markersize=marker_size, markerfacecolor='none', markeredgewidth=marker_width, label='$d^* = d_{90}^{\\mathrm{bed}}$')
