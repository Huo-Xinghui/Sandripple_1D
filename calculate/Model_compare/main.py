...
epsilon_3D = 0.6615  # restitution coefficient for 3D bed
nu_3D = -0.8221  # friction coefficient for 3D bed
# Calculation parameters
perform_calculations = True
thd_min = 0.1  # minimum impact angle
thd_max = 40.0  # maximum impact angle
