...
if perform_calculations:
    ...
    #    'ex_25': ex_array_45,
    #}
    np.savez('rb_vs_sigma_mono.npz', **rslt_dict_simple)
    ...
    #    'ex_45': ex_array_45,
    #}
    #np.savez('rb_vs_sigma_simple_monod3.npz', **rslt_dict_3D)
...
rslt_dict_smonod2 = np.load('rb_vs_sigma_simple_monod2.npz')
rslt_dict_smonod3 = np.load('rb_vs_sigma_simple_monod3.npz')
...
ax.plot(rslt_dict_2D['sigma'], rslt_dict_2D['phid_15'], 'r--', linewidth=linewidth)
ax.plot(rslt_dict_2D['sigma'], rslt_dict_2D['phid_30'], 'g--', linewidth=linewidth)
ax.plot(rslt_dict_2D['sigma'], rslt_dict_2D['phid_45'], 'b--', linewidth=linewidth)
...
ax.plot(rslt_dict_dm['sigma'], rslt_dict_dm['phid_15'], 'r:', linewidth=linewidth)
ax.plot(rslt_dict_dm['sigma'], rslt_dict_dm['phid_30'], 'g:', linewidth=linewidth)
ax.plot(rslt_dict_dm['sigma'], rslt_dict_dm['phid_45'], 'b:', linewidth=linewidth)
...
ax.plot(rslt_dict_2D['sigma'], rslt_dict_2D['e_15'], 'r--', linewidth=linewidth)
ax.plot(rslt_dict_2D['sigma'], rslt_dict_2D['e_30'], 'g--', linewidth=linewidth)
ax.plot(rslt_dict_2D['sigma'], rslt_dict_2D['e_45'], 'b--', linewidth=linewidth)
...
ax.legend([symbol_15, symbol_20, symbol_30, symbol_45],
...
inset_ax = inset_axes(ax, width='39%', height='39%', loc='upper left')
...
inset_ax.legend([dashed_line_m, solid_line_m, dashed_line_g, solid_line_g],
                ['$\\theta = 15^{\\circ}$ mono-$d_2$', '$\\theta = 15^{\\circ}$ mono-$d_3$', '$\\theta = 45^{\\circ}$ mono-$d_2$', '$\\theta = 45^{\\circ}$ mono-$d_3$'],
                fontsize=ticks_size,
                loc='upper right',
                bbox_to_anchor=(1.97, 1.05),
                frameon=True)
...
#ax.plot(sigma_array_2D, ex_array_2D_30, 'g^', markersize=marker_size, markerfacecolor='none', markeredgewidth=marker_width)
...
#ax.plot(sigma_array_3D, ex_array_3D_30, 'g^', markersize=marker_size, markeredgewidth=marker_width)
...
#ax.plot(rslt_dict_d50['sigma'], rslt_dict_d50['ex_30'], 'g-', linewidth=linewidth)
...
#ax.plot(rslt_dict_d90['sigma'], rslt_dict_d90['ex_30'], 'g--', linewidth=linewidth)
...
ax.legend([thin_line, dashed_line, dotted_line], ['$d = \\mathbb{E}[d]$', '$d = d_{50}$', '$d = d_{90}$'], fontsize=ticks_size, loc='best', frameon=True)

inset_ax = inset_axes(ax, width='39%', height='39%', loc='lower left')
