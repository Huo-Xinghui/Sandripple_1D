module public_val
    ...
    real(kind=dbPc), parameter :: rhoP = 3000.0 ! particle density
    ...
    real(kind=dbPc), parameter :: resN = 0.66 ! normal restitution coefficient
    real(kind=dbPc), parameter :: resT = -0.79 ! tangential restitution coefficient
    ...
    real(kind=dbPc), parameter :: gammaE = 0.047 ! energy fraction that returns to bed surface
